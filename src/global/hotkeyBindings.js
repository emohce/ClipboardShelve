...
export const HOTKEY_BINDINGS = [
  ...
  {
    layer: "main",
    shortcutId: "ctrl+shift+1",
    features: ["list-drawer-sub-1"],
  },
  {
    layer: "main",
    shortcutId: "ctrl+shift+2",
    features: ["list-drawer-sub-2"],
  },
  {
    layer: "main",
    shortcutId: "ctrl+shift+3",
    features: ["list-drawer-sub-3"],
  },
  {
    layer: "main",
    shortcutId: "ctrl+shift+4",
    features: ["list-drawer-sub-4"],
  },
  {
    layer: "main",
    shortcutId: "ctrl+shift+5",
    features: ["list-drawer-sub-5"],
  },
  {
    layer: "main",
    shortcutId: "ctrl+shift+6",
    features: ["list-drawer-sub-6"],
  },
  {
    layer: "main",
    shortcutId: "ctrl+shift+7",
    features: ["list-drawer-sub-7"],
  },
  {
    layer: "main",
    shortcutId: "ctrl+shift+8",
    features: ["list-drawer-sub-8"],
  },
  {
    layer: "main",
    shortcutId: "ctrl+shift+9",
    features: ["list-drawer-sub-9"],
  },
  { layer: "main", shortcutId: "ctrl+alt+f", features: ["tag-search"] },
  { layer: "main", shortcutId: "ctrl+shift+f", features: ["tag-search"] },
];
