...
export const HOTKEY_BINDINGS = [
  ...
  { layer: 'main', shortcutId: 'alt+3', features: ['main-alt-tab-3'] },
  { layer: 'main', shortcutId: 'alt+4', features: ['main-alt-tab-4'] },
  { layer: 'main', shortcutId: 'alt+5', features: ['main-alt-tab-5'] },
  { layer: 'main', shortcutId: 'alt+6', features: ['main-alt-tab-6'] },
  { layer: 'main', shortcutId: 'alt+7', features: ['main-alt-tab-7'] },
  { layer: 'main', shortcutId: 'alt+8', features: ['main-alt-tab-8'] },
  { layer: 'main', shortcutId: 'alt+9', features: ['main-alt-tab-9'] },
  ...
  { layer: 'main', shortcutId: 'ctrl+1', features: ['list-quick-copy-1'] },
  { layer: 'main', shortcutId: 'ctrl+2', features: ['list-quick-copy-2'] },
  { layer: 'main', shortcutId: 'ctrl+3', features: ['list-quick-copy-3'] },
  { layer: 'main', shortcutId: 'ctrl+4', features: ['list-quick-copy-4'] },
  { layer: 'main', shortcutId: 'ctrl+5', features: ['list-quick-copy-5'] },
  { layer: 'main', shortcutId: 'ctrl+6', features: ['list-quick-copy-6'] },
  { layer: 'main', shortcutId: 'ctrl+7', features: ['list-quick-copy-7'] },
  { layer: 'main', shortcutId: 'ctrl+8', features: ['list-quick-copy-8'] },
  { layer: 'main', shortcutId: 'ctrl+9', features: ['list-quick-copy-9'] },
