...
export const FEATURE_LABELS = {
  ...
  'list-drawer-sub-4': '抽屉内执行第 4 个功能（Ctrl+Alt+4）',
  'list-drawer-sub-5': '抽屉内执行第 5 个功能（Ctrl+Alt+5）',
  'list-drawer-sub-6': '抽屉内执行第 6 个功能（Ctrl+Alt+6）',
