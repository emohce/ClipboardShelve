...
1. **检查监听程序状态**
   - 打开插件设置页面（点击 💡 按钮）
   - 查看"剪贴板监听程序状态"
   - 如果显示"未安装"，需要手动安装监听程序（参考 [剪贴板监听问题排查.md](fix/剪贴板监听问题排查.md)）
...
在控制台执行完整调试脚本（参考 [剪贴板监听问题排查.md](fix/剪贴板监听问题排查.md)）：
...
**解决方案**：
参考 [剪贴板监听问题排查.md](fix/剪贴板监听问题排查.md) 进行排查
...
- [剪贴板监听问题排查.md](fix/剪贴板监听问题排查.md) - 监听功能问题排查
- [查找数据库和监听程序路径.md](fix/查找数据库和监听程序路径.md) - 路径查找方法
