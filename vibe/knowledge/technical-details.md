...
| Rich file preview | Vue / uTools preload / PDF.js / uTools Sharp / JSZip | [../../src/cpns/FileRichPreview.vue](../../src/cpns/FileRichPreview.vue:1), [../../src/utils/filePreview.mjs](../../src/utils/filePreview.mjs:1), [../../scripts/utools-runtime-assets.mjs](../../scripts/utools-runtime-assets.mjs:1) | PDF first page prefers uTools Sharp and falls back to PDF.js background fill; text/CSV use async head reads; DOCX/XLSX use async binary reads; PPTX/PPSX use low-fidelity text extraction; non-PDF parser results use runtime cache. | 2026-06-17 |
